...
def main():
    ...
    sub_laser = rospy.Subscriber('/marrtino/laser/scan', LaserScan, clbk_laser)
    sub_odom = rospy.Subscriber('/marrtino/odom', Odometry, clbk_odom)
    ...
    model_state.model_name = 'marrtino'
